...
class SavedReelsPlayerScreen extends StatefulWidget {
  final String? initialReelId;
  final String? heroTag;
  final String? heroThumbUrl;

  const SavedReelsPlayerScreen({
    super.key,
    this.initialReelId,
    this.heroTag,
    this.heroThumbUrl,
  ...
  @override
  State<SavedReelsPlayerScreen> createState() => _SavedReelsPlayerScreenState();
}

class _SavedReelsPlayerScreenState extends State<SavedReelsPlayerScreen> {
